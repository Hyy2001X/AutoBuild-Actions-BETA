...
ExtraPackages_SVN luci-app-adguardhome https://github.com/project-openwrt/openwrt/trunk/package/ctcgfw
ExtraPackages_SVN AdGuardHome https://github.com/project-openwrt/openwrt/trunk/package/ntlf9t
